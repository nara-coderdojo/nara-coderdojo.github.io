...
初参加のニンジャのお父様がメンターを希望されていたのでお話を伺いました。といっても、私の会社の同僚なので知っている方なのです。お仕事はプログラマーですのでお子さんの作るスクラッチを教えていたのにだんだん分からなくなってきたそう。(ですよね、私ももうついて行けてませんから)  
...
リザルト画面ではミスタッチの回数なども表示されて細かいところまでよく作られていました。  
